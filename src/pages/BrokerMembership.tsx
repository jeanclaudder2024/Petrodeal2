...
const BrokerSetup = () => {
  ...
  if (membershipStatus && membershipStatus.has_membership && membershipStatus.payment_status === 'paid') {
    // User is already a broker, hide the page
    return <div className="flex items-center justify-center h-64 text-lg font-semibold text-green-600">You are already a broker. This page is only for users who are not brokers.</div>;
  }
