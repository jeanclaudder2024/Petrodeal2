...
import UserDocumentStorage from '@/components/UserDocumentStorage';
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* Available Documents */}
          <VesselDocuments vesselId={Number(vessel.id)} vesselData={vessel} />
          
          {/* User Document Storage */}
          <UserDocumentStorage vesselId={Number(vessel.id)} />
        </div>
