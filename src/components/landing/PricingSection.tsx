      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="text-5xl font-bold mb-8 leading-tight animate-fade-in-up animation-delay-200 text-zinc-50 md:text-7xl">
            {content?.title || "Choose Your Trading Power"}
          </h2>
          
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed animate-fade-in-up animation-delay-400">
            {content?.description || "Scale your oil trading operations with flexible plans designed for every level of business, from independent traders to global enterprises."}
          </p>
        </div>

        {/* Pricing Cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {plans.map((plan, index) => <Card key={index} className={`group relative p-8 border-0 bg-gradient-to-br from-card/90 to-card/60 backdrop-blur-xl hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] animate-fade-in-up ${plan.popular ? 'ring-2 ring-accent/50 shadow-accent/20' : ''}`} style={{
