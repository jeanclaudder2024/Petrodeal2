-- Enable RLS on ports table
ALTER TABLE public.ports ENABLE ROW LEVEL SECURITY;

-- Create RLS policies for ports
CREATE POLICY "Authenticated users can view ports" ON public.ports FOR SELECT USING (true);
CREATE POLICY "Authenticated users can insert ports" ON public.ports FOR INSERT WITH CHECK (true);
CREATE POLICY "Authenticated users can update ports" ON public.ports FOR UPDATE USING (true);
CREATE POLICY "Authenticated users can delete ports" ON public.ports FOR DELETE USING (true);

-- Now create the vessels table with your exact specification
